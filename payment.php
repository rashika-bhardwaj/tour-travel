...
if(isset($pay))
{
$query=mysqli_query($con,"select * from booked_package where email='$user' order by id desc limit 1");
$res=mysqli_fetch_assoc($query);
$id=$res['id'];

$sql1=mysqli_query($con,"update booked_package set payment_mode='$payments' where id='$id' ");

	if($sql1)
	{
	header('location:user/dashboard/index.php?option=booking_package');	
	}
	else
	{
