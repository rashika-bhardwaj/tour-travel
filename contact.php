...
if(isset($submit))
{
	mysqli_query($con,"insert into query values ('','$name','$email','$subject','$msg')");
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_2.jpg');">
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> Modinagar, Ghaziabad, U.P. 201201</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">+91 9690186077</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:rashu9837@gmail.com">rashu9837@gmail</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">besttripplan.com</a></p>
          </div>
        </div>
